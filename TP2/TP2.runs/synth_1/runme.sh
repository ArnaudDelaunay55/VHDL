...
HD_PWD='/home/itii4/Documents/TP2/TP2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log generateur.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source generateur.tcl
